...
M.components = {
  ...
  winbar_filetype = { 'filetype', colored = true,  icon_only = true },
  winbar_filename = { 'filename', path = 1,        file_status = true },
  winbar_filetype_inactive = { 'filetype', colored = false, icon_only = true, color = { fg = colors.grey, bg = colors.bg0 } },
  winbar_filename_inactive = { 'filename', path = 1,        file_status = true, color = { fg = colors.grey, bg = colors.bg0 } },
}
