...
nnoremap("<C-m><C-r>", "<cmd>lua vim.diagnostic.reset()<CR>", { desc = "Format" })
...
nnoremap("<leader><C-k>", "<Cmd>lua vim.lsp.buf.signature_help()<CR>", { desc = "Signature help" })
...
nnoremap('gr', [[:lua require("fzf-lua").lsp_references()<CR>]], { desc = "References" })
